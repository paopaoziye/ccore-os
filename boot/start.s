//定义宏loop，参数为cunt，即外层循环次数，内层循环次数固定为65535
.macro      loop,cunt                
    li		t1,	0xffff                    //将t1设置为0xffff即65535
    li		t2,	\cunt                     //将t2设置为cunt
1:
	nop                                   //空操作
	addi    t1, t1, -1                    //t1 = t1-1
	bne		t1, x0, 1b                    //若t1 != 0，跳转到标签1，即继续内层循环
    li		t1,	0xffff                    //重置t1 = 0xffff
	addi    t2, t2, -1                    //t2 = t2-1
	bne		t2, x0, 1b                    //若t2 != 0，跳转到标签1，即继续外层循环
.endm                                     
...
1:
	lw      t0, (\_src_start)             //从_src_start加载32位（一个字）数据到t0
...
//将opensbi_fw.bin和qemu_sbi.dtb从flash拷贝到DRAM
//将a1设置为设备树地址并跳转到拷贝后的opensbi_fw.bin运行
_start:
	...
	//将load trusted_fw.bin从0x20400000拷贝到0x80200000处
    li		a0,	0x204
