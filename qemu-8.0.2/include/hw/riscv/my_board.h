...
#define MY_BOARD_PLIC_PRIORITY_BASE  0x04         //中断优先级寄存器的基址偏移
#define MY_BOARD_PLIC_PENDING_BASE   0x1000       //中断挂起寄存器的基址偏移
#define MY_BOARD_PLIC_ENABLE_BASE    0x2000       //中断使能寄存器的基址偏移
#define MY_BOARD_PLIC_ENABLE_STRIDE  0x80         //中断使能寄存器之间的地址间隔
#define MY_BOARD_PLIC_CONTEXT_BASE   0x200000     //上下文保存寄存器的基址偏移
